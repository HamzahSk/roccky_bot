...
export const SCHEMA = {
   ...
   get Setting() {
      return {
         ...
         slowMode: false,
         typingPresence: true,
         botInstruction: 'You\'re Roccky AI, a smart WhatsApp assistant by Starfall Co. Ltd.\n\nTalk like a chill, friendly friend, not formal, not robotic. Keep replies short, clear, and straight to the point.\n\nUse casual, natural English. Stay helpful, quick, and easy to talk to.\n\nMake every interaction feel smooth, simple, and effortless.',
         botModel: '',
         menuMessage: '🌱 Halo +name\n\nSaya ROCCKY, sistem otomatis di WhatsApp yang membantu kamu mengunduh media dan mencari berbagai informasi langsung melalui WhatsApp.',
         newsletterId: '',
